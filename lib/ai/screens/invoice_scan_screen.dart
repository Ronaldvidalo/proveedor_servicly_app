...
// CRUCIAL: Ocultamos 'Invoice' de gemini_service para que la pantalla SÓLO use 
// la definición de Invoice que viene del modelo (ai_response_model.dart).
import 'package:proveedor_servicly_app/ai/services/gemini_service.dart' hide Invoice; 
import 'package:proveedor_servicly_app/ai/model/ai_response_model.dart'; // Contiene la definición de Invoice (modelo)
...
import 'package:proveedor_servicly_app/providers/app_providers.dart'; 
